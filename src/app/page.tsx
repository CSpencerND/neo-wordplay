...
export default function Home() {
    return (
        <>
            ...
            <section className={cn("prose max-w-none", "bg-blur-300")}>
                <article
                    style={{
                        backgroundImage: `url("/assets/effects/about-bg.svg")`,
                    }}
                    className="bg-cover bg-clip-text bg-center bg-no-repeat"
                >
