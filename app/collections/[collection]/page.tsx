                ...
                edges: [
                    {
                        node: {
                            ...
                            description:
                                "S M L XL 3XL Width, cm 47 52.1 57.2 62.2 72.4 Length, cm 72.4 74.9 77.5 80 85.1 Sleeve length, cm 17.8 19 20.3 21.3 24.8 This ultra cotton tee has the classic cotton look and feel. Excellent quality print adds statement to casually elegant appearance. .: Classic fit.: 100% Cotton (fibre content may vary for different colors).: Light fabric (6.0 oz/yd² (203 g/m²)).: Sewn in label.: Runs bigger than usual",
                            priceRange: {
                                minVariantPrice: {
                                    amount: "25.0",
                                },
                        ...
                        node: {
                            ...
                            options: [
                                ...
                                },
                                {
                                    ...
                                    name: "Size",
                                    values: ["L", "S", "M", "XL", "2XL", "3XL", "4XL", "5XL"],
                                },
                            ],
                        },
                    },
                    ...
                    },
                    {
                        node: {
                            ...
                            description:
                                "This lightweight shirt has a fitted and narrow cut that will highlight feminine curves. Durable print allows one to stand out in every occasion. .: Junior fit.: 100% Soft cotton (fibre content may vary for different colors).: Light fabric (4.5 oz/yd² (153 g/m²)).: Tear away label.: Runs true to size",
                            priceRange: {
                                minVariantPrice: {
                                    amount: "18.46",
                                },
                    ...
                    },
                    {
                        node: {
                            ...
                            title: "Graffiti",
                            description:
                                "This updated unisex essential fits like a well-loved favorite. Super soft cotton and excellent quality print makes one to fall in love with it over and over again..: 100% Airlume combed and ringspun cotton (fiber content may vary for different colors).: Light fabric (4.2 oz/yd² (142 g/m²)).: Retail fit.: Tear away label.: Runs true to sizeImage by [Sokol Artstudio / Shutterstock]",
                            priceRange: {
                                minVariantPrice: {
                                    amount: "14.58",
                                },
                    ...
                    },
                    {
                        node: {
                            ...
                            title: "MLK DREAMERS",
                            description:
                                "This comfortable unisex short sleeve offers men a mid-weight piece of clothing for all casual occasions. With an attention-grabbing print, it will be an instant favorite..: 100% preshrunk cotton.: Light fabric (5.2 oz /yd² (176 g/m²)).: Relaxed fit.: Tear away label.: Runs true to sizeImage by [Tharun 15 / Shutterstock]",
                            priceRange: {
                                minVariantPrice: {
                                    amount: "15.61",
                                },
                    ...
                    },
                    {
                        node: {
                            ...
                            description:
                                "This ultra cotton tee has the classic cotton look and feel. Excellent quality print adds statement to casually elegant appearance. .: Classic fit.: 100% Cotton (fibre content may vary for different colors).: Light fabric (6.0 oz/yd² (203 g/m²)).: Sewn in label.: Runs bigger than usual",
                            priceRange: {
                                minVariantPrice: {
                                    amount: "25.0",
                                },
